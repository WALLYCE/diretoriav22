...
const migracao_base = ` SELECT k.cod_cliente,
k.nome_cliente,
k.cidade,
k.vendedor,
k.plano,
...
exports.getMigracoesCidade = async(req, res, next)=>{         
    ...
    k.plano as Plano,
    k.valor as Valor,
    k.plano_antigo as "Plano(Anterior)"  from (${migracao_base}) as k where k.data_contrato>= '${req.body['data_inicial']}' and k.data_contrato<= '${req.body['data_final']}';`;
 ...
 exports.getMigracoesVendedores = async(req, res, next)=>{         
