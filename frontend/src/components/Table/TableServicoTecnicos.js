...
function TableServicoTecnicos(props) {
   ...
   setBackdrop(true)
   const result = await api.post('/relatorio_tecnicos_rede',{ data_inicial: dataInicial.split('T')[0], data_final: dataFinal.split('T')[0] })
  ...
  return (
    ...
    <TableContainer component={Paper}>
      <Table sx={{ minWidth: 700 }} aria-label="customized table">
        <TableHead>
          <TableRow>
            <StyledTableCell>Nº O.S</StyledTableCell>
            <StyledTableCell align="right">Cod. Cliente</StyledTableCell>
            <StyledTableCell align="right">Tipo</StyledTableCell>
            <StyledTableCell align="right">Tecnicos</StyledTableCell>
            <StyledTableCell align="right">Referência</StyledTableCell>
            <StyledTableCell align="right">Data Inicio</StyledTableCell>
            <StyledTableCell align="right">Data Termino</StyledTableCell>
            <StyledTableCell align="right">Fechamento</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {dados.map((row) => (
            <StyledTableRow key={row.numero_ordem_servico}>
              <StyledTableCell component="th" scope="row">
                {row.numero_ordem_servico}
              </StyledTableCell>
              <StyledTableCell align="right">{row.codigo_cliente}</StyledTableCell>
              <StyledTableCell align="right">{row.descricao}</StyledTableCell>
              <StyledTableCell align="right">{row.tecnicos}</StyledTableCell>
              <StyledTableCell align="right">{row.referencia}</StyledTableCell>
              ...
              <StyledTableCell align="right">{row.descricao_fechamento}</StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
...
export default TableServicoTecnicos;