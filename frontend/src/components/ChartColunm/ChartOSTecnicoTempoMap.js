...
function ChartProspectoVendedor(props) {
    ...
    useEffect(()=> {
      ...
      api.post('/relatorio_tecnicos_rede/ordem_servico/tempo_execucao/map',{ data_inicial: dataInicial.split('T')[0], data_final: dataFinal.split('T')[0] })
        .then(result => {
    ...
    const options = {
      title: "MAP - Ordem de serviços realizadas e não realizadas no prazo",
