...
export default function ModalProdutoItemEstoque(props) {
      ...
      >
        ...
        <DialogContent dividers>
          ...
          <Grid container mt={1} mb={1} spacing={3}>
                ...
                <Grid item xs={2.4} md={2.4}  sm={2.4}>
          <Button  
            variant="inherit"  sx={{
          ':hover': {
          ...
          p: 0.5
           ...
           onClick={()=>{
             setDadosLista(estoque)
             setColunasLista(coluna_estoque)
             setOpenLista(true)
           }} >
            <Cartao titulo={'Estoque'} icone={'Estoque'} valor={estoque.length} color={'green'}/>
        </Button>
          ...
          p: 0.5
           ...
           onClick={()=>{
            setDadosLista(comodato)
            setColunasLista(coluna_comodato)
            setOpenLista(true)
          }}> <Cartao titulo={'Comodato'} icone={'Comodato'} valor={comodato.length}  color={'blue'}/></Button>
                </Grid>
          ...
          p: 0.5
           ...
           onClick={()=>{
            setDadosLista(usuario)
            setColunasLista(coluna_usuario)
            setOpenLista(true)
          }}>  <Cartao titulo={'Usuário'} icone={'funcionario'} valor={usuario.length}  color={'purple'}/></Button>
                </Grid>
                <Grid item xs={2.4} md={2.4}  sm={2.4}>
                <Button  
            variant="inherit"  sx={{
          ...
          p: 0.5
           ...
           onClick={()=>{
            setDadosLista(perdidos)
            setColunasLista(coluna_perdidos)
            setOpenLista(true)
          }}>  <Cartao titulo={'Perdidos'} icone={'perdido'} valor={perdidos.length}  color={'red'}/></Button>
                </Grid>
                <Grid item xs={2.4} md={2.4}  sm={2.4}>
                <Button  
            variant="inherit"  sx={{
          ...
          p: 0.5
           ...
           onClick={()=>{
            setDadosLista(outros)
            setColunasLista(coluna_outros)
            setOpenLista(true)
          }}>  <Cartao titulo={'Outros'} icone={outros.length} valor={outros.length}  color={'blue'}/></Button>
                </Grid>
       </Grid>
